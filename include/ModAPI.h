...
namespace Messaging
{
	...
	public:
		...
		virtual int AddRotationPoint(SKSE::PluginHandle a_pluginHandle, size_t a_timelineID, float a_time, const RE::BSTPoint2<float>& a_rotation, bool a_easeIn = false, bool a_easeOut = false, FCFW_API::InterpolationMode a_interpolationMode = FCFW_API::InterpolationMode::kCubicHermite) const noexcept override;
		virtual int AddRotationPointAtRef(SKSE::PluginHandle a_pluginHandle, size_t a_timelineID, float a_time, RE::TESObjectREFR* a_reference, FCFW_API::BodyPart a_bodyPart = FCFW_API::BodyPart::kNone, const RE::BSTPoint2<float>& a_offset = RE::BSTPoint2<float>(), bool a_isOffsetRelative = false, bool a_easeIn = false, bool a_easeOut = false, FCFW_API::InterpolationMode a_interpolationMode = FCFW_API::InterpolationMode::kCubicHermite) const noexcept override;
